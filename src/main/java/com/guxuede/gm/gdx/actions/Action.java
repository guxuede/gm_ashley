...
abstract public class Action implements Poolable {
	...
	/** Sets the actor this action is attached to. This also sets the {@link #setTarget(Entity) target} actor if it is null. This
	...
	/** Sets the actor this action will manipulate. If no target actor is set, {@link #setActor(Entity)} will set the target actor
